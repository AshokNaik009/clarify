...
description: Run a Socratic Q&A loop until ambiguity drops below threshold, then crystallize an immutable seed.yaml. Brownfield-aware — auto-confirms manifest-known facts.
